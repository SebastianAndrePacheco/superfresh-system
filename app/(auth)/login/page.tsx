  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="max-w-md w-full space-y-8 p-8 bg-gray-900 rounded-lg shadow-2xl border border-gray-800">
        <div>
          <h2 className="text-3xl font-bold text-center text-white">Superfresh</h2>
          <p className="mt-2 text-center text-gray-400">Sistema de Control de Producción</p>
        </div>
        <form onSubmit={handleLogin} className="mt-8 space-y-6">
          ...
          {error && (
            <div className="text-red-400 text-sm text-center bg-red-900/20 p-3 rounded border border-red-900">{error}</div>
          )}
